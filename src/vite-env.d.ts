...
interface ImportMetaEnv {
    ...
    readonly VITE_APPWRITE_BUYERS_COLLECTION_ID: string
    readonly VITE_APPWRITE_SELLERS_COLLECTION_ID: string
    readonly VITE_APPWRITE_DEALS_COLLECTION_ID: string
    readonly VITE_APPWRITE_MESSAGES_COLLECTION_ID: string
    readonly VITE_APPWRITE_MATCHES_COLLECTION_ID: string
    readonly VITE_APPWRITE_DOCUMENTS_BUCKET_ID: string
