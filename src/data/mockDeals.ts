...
export const mockDeals: AcquisitionDeal[] = [
  {
    ...
    buyerId: '1', // Current logged-in user
    sellerId: 'seller-1',
  ...
  
  {
    ...
    buyerId: 'buyer-3',
    sellerId: '1', // Current logged-in user as seller
    ...
    seller: {
      ...
      firstName: 'John',
      lastName: 'Doe',
      company: 'DoeFlow Solutions',
      email: 'john@doeflow.com',
      avatar: 'JD',
    },
    
    business: {
      id: 'business-2',
      name: 'DoeFlow Solutions',
      industry: 'Technology',
      location: 'Portland, OR',
      revenue: '$1.2M',
      valuation: '$900K',
      description: 'Business process automation consulting firm',
    },
